...
(isset($context["page"]) ? $context["page"] : null), "sidebar_second", array()) && twig_test_empty($this->getAttribute((isset($context["page"]) ? $context["page"] : null), "sidebar_first", array())))) ? ("col-sm-12 col-md-10") : ("")), 3 => (((twig_test_empty($this->getAttribute(        // line 65
    ...
    <div class=\"row\">
      ...
      {%
        set content_classes = [
          ...
          page.sidebar_second and page.sidebar_first is empty ? 'col-sm-12 col-md-10',
